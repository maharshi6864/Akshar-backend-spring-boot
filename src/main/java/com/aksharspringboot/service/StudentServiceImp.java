    ...
    public Response addStudent(StudentDto studentDto) {
        try {
            ...
            StudentVo studentVo = new StudentVo(null, studentDto.getEnrollmentNumber(), studentDto.getFirstName(),
                    studentDto.getLastName(),studentDto.getStudentEmailAddress(),studentDto.getFilePath(),studentDto.getEncodingsPath(),false, savedUserVo,
    ...
    public Response getAllStudent() {
        ...
        try {
            ...
            for (StudentVo studentVo : studentVoList) {
                StudentDto studentDto = new StudentDto(studentVo.getId(), studentVo.getEnrollmentNumber(), studentVo.getFirstName(), studentVo.getLastName(),studentVo.getEmailAddress(),studentVo.getFilePath(),false,studentVo.getEncodingsPath(),null, studentVo.getCourseVo().getId(), studentVo.getCourseVo().getCourseName(), studentVo.getCourseVo().getCourseShortName(),null);
